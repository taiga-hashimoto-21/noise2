...
def adjust_learning_rate_warmup(optimizer, epoch, total_epochs=100, warmup_epochs=10, base_lr=0.001, min_lr=1e-6):
    if epoch < warmup_epochs:
        ...
        cosine_ratio = cosine_epoch / cosine_total
        lr = min_lr + 0.5 * (base_lr - min_lr) * (1 + math.cos(math.pi * cosine_ratio))
